...
(defvar luna-font-alist
  `(("SF Mono" "SF Mono" "Source Han Serif SC" 1.3)
    ...
    ("Academica" "Academica Book" "Source Han Serif SC" 1)
    ...
    ("PragmataPro 13" "PragmataPro Mono" nil 1 (:size 13) (:size 13)))
...
(defun luna-font-expand-spec (font-spec size &rest attrs)
  ...
  (let* ((ascii-family (nth 0 font-spec))
         ...
         (ascii-extra-spec
          (append `(:size ,size) (nth 3 font-spec) attrs))
         (cjk-extra-spec
          (append `(:size ,(* cjk-scale size)) (nth 4 font-spec) attrs))
...
See ‘luna-load-font’."
  ...
  (let* ((specs (apply #'luna-font-expand-spec font-spec size attrs))
